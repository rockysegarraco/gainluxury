...
// node_modules/sanity/lib/_chunks/desk-3aa7b32c.js
      ...
      children: (0, import_jsx_runtime.jsx)(LegacyLayerProvider, {
        ...
        children: (0, import_jsx_runtime.jsxs)(Card, {
          ...
          children: [(0, import_jsx_runtime.jsxs)(Layout, {
            ...
            }), actions && (0, import_jsx_runtime.jsx)(Flex, {
              align: "center",
              hidden: collapsed,
              children: (0, import_jsx_runtime.jsx)(LegacyLayerProvider, {
                zOffset: "paneHeader",
...
var PaneHeaderActions = (0, import_react.memo)(function PaneHeaderActions2(props) {
  const {
    initialValueTemplateItems: initialValueTemplateItemsFromStructure = EMPTY_ARRAY$a,
    menuItems = EMPTY_ARRAY$a,
    menuItemGroups = EMPTY_ARRAY$a,
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, {
    ...
    children: [(0, import_jsx_runtime.jsx)(DocumentInspectorHeader, {
      ...
      children: [validation.length === 0 && (0, import_jsx_runtime.jsx)(Box, {
        ...
        space: 2,
        children: validation.map((marker, i) => (0, import_jsx_runtime.jsx)(ValidationCard, {
          marker,
          onOpen: handleOpen,
          schemaType,
          value
...
var Root$2 = styled_components_browser_esm_default(Button)((_ref30) => {
  ...
  return Ae(_d$1 || (_d$1 = __template$3(["\n    position: relative;\n    width: 100%;\n\n    /* Line styling */\n    &[data-first] ", "::before {\n      height: 50%;\n      top: unset;\n      bottom: 0;\n    }\n\n    &[data-last] ", "::before {\n      height: 50%;\n    }\n\n    ", "\n\n    ", "\n  "])), IconWrapper, IconWrapper, $selected && Ae(_b$1 || (_b$1 = __template$3(["\n      ", "::before {\n        background: transparent;\n      }\n    "])), IconWrapper), $disabled && Ae(_c$1 || (_c$1 = __template$3(["\n      cursor: not-allowed;\n    "]))));
});
var IconBox = styled_components_browser_esm_default(Box)(_e || (_e = __template$3(["\n  background: var(--card-bg-color);\n  border-radius: 50px;\n  position: relative;\n  z-index: 2;\n"])));
var EventLabel = styled_components_browser_esm_default(Text)(_f || (_f = __template$3(["\n  text-transform: capitalize;\n"])));
var TimestampBox = styled_components_browser_esm_default(Box)(_g || (_g = __template$3(["\n  min-width: 1rem;\n  margin-left: ", ";\n"])), (_ref31) => {
  let {
    theme
  } = _ref31;
...
var deskTool = definePlugin((options) => ({
  ...
  tools: [{
    ...
    component: (0, import_react.lazy)(() => import("./index-9c45d2a0-TJ6WC2LO.js").then(function(n) {
      return n.index;
    })),
...
var isSanityDocument = (value) => isRecord$4(value) && typeof value._id === "string" && typeof value._type === "string";
...
function DocumentInspectorMenuItemsResolver(props) {
  ...
  return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {
    children: inspectors2.map((inspector, inspectorIndex) => inspector.useMenuItem && (0, import_jsx_runtime.jsx)(InspectorMenuItem, {
      documentId,
      documentType,
...
var DocumentPaneProvider = (0, import_react.memo)((props) => {
  ...
  const inspectors2 = (0, import_react.useMemo)(() => inspectorsResolver({
    documentId,
    documentType
  ...
  const menuItems = (0, import_react.useMemo)(() => getMenuItems({
    ...
    inspectors: inspectors2,
    previewUrl
  }), [currentInspector, features, hasValue, inspectorMenuItems, inspectors2, previewUrl]);
  ...
  return (0, import_jsx_runtime.jsxs)(DocumentPaneContext.Provider, {
    value: documentPane,
    children: [inspectors2.length > 0 && (0, import_jsx_runtime.jsx)(DocumentInspectorMenuItemsResolver, {
      documentId,
      documentType,
      inspectors: inspectors2,
...
//# sourceMappingURL=chunk-3WL7F5HQ.js.map
