...
var desk = require('./desk-0fed479a.js');
...
var _a$b;
const PathSegment = styled__default.default.span(_a$b || (_a$b = __template$b(["\n  &:not(:last-child)::after {\n    content: ' \u279D ';\n    opacity: 0.5;\n  }\n"])));
...
const Content = styled__default.default(ui.Flex)(_a$a || (_a$a = __template$a(["\n  opacity: 0;\n  transition: opacity 200ms;\n\n  &[data-mounted] {\n    opacity: 1;\n  }\n"])));
...
var _a$8;
const Root$3 = styled__default.default(ui.Card)(_a$8 || (_a$8 = __template$8(["\n  position: relative;\n  z-index: 50;\n"])));
    ...
    children: /* @__PURE__ */jsxRuntime.jsx(ui.Container, {
      ...
      children: /* @__PURE__ */jsxRuntime.jsxs(ui.Flex, {
        ...
        children: [/* @__PURE__ */jsxRuntime.jsx(ui.Text, {
          ...
          }), revisionId && /* @__PURE__ */jsxRuntime.jsx(ui.Button, {
            fontSize: 1,
            padding: 2,
            mode: "bleed",
            tone: "primary",
...
var _a$7, _b$1;
const Root$2 = styled__default.default(ui.Card)(_a$7 || (_a$7 = __template$7(["\n  position: relative;\n  z-index: 50;\n"])));
const TextOneLine = styled__default.default(ui.Text)(_b$1 || (_b$1 = __template$7(["\n  & > * {\n    overflow: hidden;\n    overflow: clip;\n    white-space: nowrap;\n    text-overflow: ellipsis;\n  }\n"])));
const ReferenceChangedBanner = React.memo(() => {
  ...
  const referenceInfo = reactRx.useMemoObservable(() => {
    ...
    operators.debounceTime(750), operators.map(_ref14 => {
      let {
        draft,
        published
      } = _ref14;
      ...
      return {
        ...
        result: {
          ...
          refValue: (_a3 = PathUtils.get(draft.snapshot || published.snapshot, parentRefPath)) == null ? void 0 : _a3._ref
        }
      };
    })));
...
var _a$6;
const Root$1 = styled__default.default(ui.Card)(_a$6 || (_a$6 = __template$6(["\n  position: relative;\n  z-index: 50;\n"])));
...
const FormView = React.forwardRef(function FormView2(props, ref) {
  var _a;
  const {
    hidden,
    margins
  ...
  React.useEffect(() => {
    if (ready && !(formState == null ? void 0 : formState.focusPath.length) && formRef) {
      ui.focusFirstDescendant(formRef);
    }
  }, [ready]);
...
const Scroller = styled__default.default(sanity.ScrollContainer)(_ref16 => {
  let {
    $disabled
  } = _ref16;
  if ($disabled) {
...
const DocumentPanel = function DocumentPanel2(props) {
  ...
  const formContainerElement = React.useRef(null);
  ...
  const lastNonDeletedRevId = sanity.useTimelineSelector(timelineStore, state => state.lastNonDeletedRevId);
  React.useEffect(() => {
              ...
              children: /* @__PURE__ */jsxRuntime.jsxs(sanity.VirtualizerScrollInstanceProvider, {
                ...
                children: [activeView.type === "form" && !isPermissionsLoading && ready && /* @__PURE__ */jsxRuntime.jsxs(jsxRuntime.Fragment, {
                  children: [/* @__PURE__ */jsxRuntime.jsx(PermissionCheckBanner, {
                    ...
                    requiredPermission
                  }), !isDeleting && isDeleted && /* @__PURE__ */jsxRuntime.jsx(DeletedDocumentBanner, {
...
var _a$4;
const Root = styled__default.default(ui.Flex)(_a$4 || (_a$4 = __template$4(["\n  cursor: default;\n"])));
function PublishStatus(props) {
  ...
  const a11yUpdatedAgo = sanity.useTimeAgo(lastUpdated || "", {
    minimal: false,
    agoSuffix: true
  });
  const a11yPublishedAgo = sanity.useTimeAgo(lastPublished || "", {
    minimal: false,
    agoSuffix: true
  });
      ...
      children: /* @__PURE__ */jsxRuntime.jsx(ui.Button, {
        ...
        children: /* @__PURE__ */jsxRuntime.jsxs(ui.Flex, {
          ...
          children: [/* @__PURE__ */jsxRuntime.jsx(ui.Box, {
            ...
            size: 1,
            weight: "medium",
            children: liveEdit ? /* @__PURE__ */jsxRuntime.jsx("abbr", {
              "aria-label": a11yLabel,
              children: lastUpdated ? lastUpdatedTime : lastPublishedTime
            }) : /* @__PURE__ */jsxRuntime.jsx("abbr", {
              "aria-label": a11yLabel,
...
var _a$3, _b, _c;
const StyledMotionPath = styled__default.default(framerMotion.motion.path)(_a$3 || (_a$3 = __template$3(["\n  transform-origin: center;\n"])));
...
const rotateAnimation = styled.keyframes(_b || (_b = __template$3(["\n  0% {\n    transform: rotate(0);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n"])));
  ...
  return /* @__PURE__ */jsxRuntime.jsx(ui.Tooltip, {
    ...
    content: /* @__PURE__ */jsxRuntime.jsxs(ui.Stack, {
      ...
      children: [/* @__PURE__ */jsxRuntime.jsx(ui.Text, {
        ...
        size: 1,
        muted: true,
        children: ["Changes saved ", /* @__PURE__ */jsxRuntime.jsx("abbr", {
...
var _a$2;
const DocumentActionsBox = styled__default.default(ui.Box)(_a$2 || (_a$2 = __template$2(["\n  min-width: 10em;\n  max-width: 16em;\n"])));
...
"absolute"];
const StyledChangeConnectorRoot = styled__default.default(sanity.ChangeConnectorRoot)(_a$1 || (_a$1 = __template$1(["\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  min-height: 0;\n  min-width: 0;\n"])));
...
function useConstructDocumentTitle(activeTitle) {
  const deskToolBaseTitle = desk.useDeskTool().structureContext.title;
  return [activeTitle, deskToolBaseTitle].filter(title => title).join(" | ");
}
function isDocumentPane(pane) {
  return pane !== desk.LOADING_PANE && pane.type === "document";
}
function isLoadingPane(pane) {
  return pane === desk.LOADING_PANE;
}
...
var _a;
const StyledPaneLayout = styled__default.default(PaneLayout)(_a || (_a = __template(["\n  min-height: 100%;\n  min-width: 320px;\n"])));
const isSaveHotkey = isHotkey__default.default("mod+s");
const DeskTool = React.memo(function DeskTool2(_ref22) {
  let {
    onPaneChange
  } = _ref22;
  var _a2;
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(ui.PortalProvider, {
    ...
    }), /* @__PURE__ */jsxRuntime.jsx(DeskTitle, {
      resolvedPanes
...
//# sourceMappingURL=index-fd8cd93d.js.map
