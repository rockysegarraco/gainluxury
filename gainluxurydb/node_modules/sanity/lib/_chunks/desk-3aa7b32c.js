...
const ChevronWrapper = styled(Box)(_a$d || (_a$d = __template$d(["\n  margin-left: auto;\n"])));
const CrossDatasetReferencesDetails = styled.details(_b$5 || (_b$5 = __template$d(["\n  flex: none;\n\n  &[open] ", " {\n    transform: rotate(180deg);\n  }\n"])), ChevronWrapper);
const CrossDatasetReferencesSummary = styled.summary(_c$3 || (_c$3 = __template$d(["\n  list-style: none;\n\n  &::-webkit-details-marker {\n    display: none;\n  }\n"])));
const Table = styled.table(_d$3 || (_d$3 = __template$d(["\n  width: 100%;\n  text-align: left;\n  padding: 0 ", ";\n  border-collapse: collapse;\n\n  th {\n    padding: ", ";\n  }\n\n  td {\n    padding: 0 ", ";\n  }\n\n  tr > *:last-child {\n    text-align: right;\n  }\n"])), _ref8 => {
  let {
    theme
  } = _ref8;
...
const DocumentIdFlex = styled(Flex)(_e$2 || (_e$2 = __template$d(["\n  min-height: 35px;\n"])));
...
var _a$c, _b$4;
const DialogBody = styled(Box).attrs({
  padding: 4
...
var _a$b;
const Root$b = styled(Layer)(_a$b || (_a$b = __template$b(["\n  position: relative;\n  width: 1px;\n  min-width: 1px;\n\n  &:before {\n    content: '';\n    display: block;\n    position: absolute;\n    top: 0;\n    left: 0;\n    bottom: 0;\n    width: 1px;\n    background-color: var(--card-border-color);\n  }\n\n  &:not([data-disabled]) {\n    cursor: ew-resize;\n    width: 9px;\n    min-width: 9px;\n    margin: 0 -4px;\n\n    &:before {\n      left: 4px;\n    }\n\n    &:after {\n      content: '';\n      display: block;\n      position: absolute;\n      top: 0;\n      left: 0;\n      width: 9px;\n      bottom: 0;\n      background-color: var(--card-border-color);\n      opacity: 0;\n      transition: opacity 150ms;\n    }\n\n    &[data-dragging]:after,\n    &:hover:after {\n      opacity: 0.2;\n    }\n  }\n"])));
...
var _a$a;
const Root$a = styled(Card)(_a$a || (_a$a = __template$a(["\n  outline: none;\n\n  // NOTE: This will render a border to the right side of each pane\n  // without taking up physical space.\n  box-shadow: 1px 0 0 var(--card-border-color);\n"])));
...
var _a$9;
const Root$9 = styled(Card)(_a$9 || (_a$9 = __template$9(["\n  position: relative;\n  outline: none;\n"])));
...
var _a$8, _b$3;
const Root$8 = styled(Layer)(_a$8 || (_a$8 = __template$8(["\n  position: sticky;\n  bottom: 0;\n\n  &:before {\n    content: '';\n    display: block;\n    position: absolute;\n    left: 0;\n    right: 0;\n    top: -1px;\n    border-bottom: 1px solid var(--card-shadow-outline-color);\n  }\n"])));
const RootCard = styled(Card)(_b$3 || (_b$3 = __template$8(["\n  padding-bottom: env(safe-area-inset-bottom);\n"])));
...
const Root$7 = styled(Layer)(_a$7 || (_a$7 = __template$7(["\n  line-height: 0;\n  position: sticky;\n  top: 0;\n\n  &:not([data-collapsed]):after {\n    content: '';\n    display: block;\n    position: absolute;\n    left: 0;\n    right: 0;\n    bottom: -1px;\n    border-bottom: 1px solid var(--card-shadow-outline-color);\n  }\n"])));
const Layout = styled(Flex)(_b$2 || (_b$2 = __template$7(["\n  transform-origin: calc(51px / 2);\n\n  [data-collapsed] > div > & {\n    transform: rotate(90deg);\n  }\n"])));
...
const TitleTextSkeleton = styled(TextSkeleton)(_d$2 || (_d$2 = __template$7(["\n  width: 66%;\n  max-width: 175px;\n"])));
const TitleText = styled(Text)(_e$1 || (_e$1 = __template$7(["\n  cursor: default;\n  outline: none;\n"])));
...
var _a$6;
const Root$6 = styled(Card)(_a$6 || (_a$6 = __template$6(["\n  transition: opacity 200ms;\n  position: relative;\n  z-index: 1;\n  padding-left: env(safe-area-inset-left);\n  padding-right: env(safe-area-inset-right);\n  opacity: 0;\n\n  &:not([hidden]) {\n    display: flex;\n  }\n\n  &:not([data-collapsed]) {\n    overflow: auto;\n  }\n\n  &[data-mounted] {\n    opacity: 1;\n  }\n\n  &[data-resizing] {\n    pointer-events: none;\n  }\n"])));
...
var _a$5;
const Root$4 = styled.div(_a$5 || (_a$5 = __template$5(["\n  position: absolute;\n  top: 0;\n  left: -4px;\n  bottom: 0;\n  width: 9px;\n  z-index: 201;\n  cursor: ew-resize;\n\n  /* Border */\n  & > span:nth-child(1) {\n    display: block;\n    border-left: 1px solid var(--card-border-color);\n    position: absolute;\n    top: 0;\n    left: 4px;\n    bottom: 0;\n    transition: opacity 200ms;\n    opacity: 0.5;\n  }\n\n  /* Hover effect */\n  & > span:nth-child(2) {\n    display: block;\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 9px;\n    bottom: 0;\n    background-color: var(--card-border-color);\n    opacity: 0;\n    transition: opacity 150ms;\n  }\n\n  @media (hover: hover) {\n    &:hover > span:nth-child(2) {\n      opacity: 0.2;\n    }\n  }\n"])));
...
var _a$4;
const Root$3 = styled(Box)(_a$4 || (_a$4 = __template$4(["\n  position: relative;\n  flex: 1;\n  padding-left: 1px;\n"])));
  ...
  return /* @__PURE__ */jsxs(Flex, {
    ...
    children: [/* @__PURE__ */jsx(DocumentInspectorHeader, {
      ...
      children: [validation.length === 0 && /* @__PURE__ */jsx(Box, {
        ...
        space: 2,
        children: validation.map((marker, i) => /* @__PURE__ */jsx(ValidationCard, {
          marker,
          onOpen: handleOpen,
          schemaType,
          value
...
const Root$2 = styled(Button)(_ref30 => {
  ...
  return css(_d$1 || (_d$1 = __template$3(["\n    position: relative;\n    width: 100%;\n\n    /* Line styling */\n    &[data-first] ", "::before {\n      height: 50%;\n      top: unset;\n      bottom: 0;\n    }\n\n    &[data-last] ", "::before {\n      height: 50%;\n    }\n\n    ", "\n\n    ", "\n  "])), IconWrapper, IconWrapper, $selected && css(_b$1 || (_b$1 = __template$3(["\n      ", "::before {\n        background: transparent;\n      }\n    "])), IconWrapper), $disabled && css(_c$1 || (_c$1 = __template$3(["\n      cursor: not-allowed;\n    "]))));
});
const IconBox = styled(Box)(_e || (_e = __template$3(["\n  background: var(--card-bg-color);\n  border-radius: 50px;\n  position: relative;\n  z-index: 2;\n"])));
const EventLabel = styled(Text)(_f || (_f = __template$3(["\n  text-transform: capitalize;\n"])));
const TimestampBox = styled(Box)(_g || (_g = __template$3(["\n  min-width: 1rem;\n  margin-left: ", ";\n"])), _ref31 => {
  let {
    theme
  } = _ref31;
...
var _a$2, _b, _c, _d;
const StackWrapper = styled(Stack)(_a$2 || (_a$2 = __template$2(["\n  max-width: 200px;\n"])));
const ListWrapper = styled(Flex)(_b || (_b = __template$2(["\n  max-height: calc(100vh - 198px);\n  min-width: 244px;\n"])));
const Root$1 = styled(Box)(_ref33 => {
  let {
    $visible
  } = _ref33;
  return css(_d || (_d = __template$2(["\n    opacity: 0;\n    pointer-events: none;\n\n    ", "\n  "])), $visible && css(_c || (_c = __template$2(["\n      opacity: 1;\n      pointer-events: auto;\n    "]))));
});
...
var _a$1;
const Root = styled(Popover)(_a$1 || (_a$1 = __template$1(["\n  overflow: hidden;\n  overflow: clip;\n"])));
...
var _a;
const Scroller = styled(ScrollContainer)(_a || (_a = __template(["\n  height: 100%;\n  overflow: auto;\n  position: relative;\n  scroll-behavior: smooth;\n"])));
...
const deskTool = definePlugin(options => ({
  ...
  tools: [{
    ...
    component: lazy(() => import('./index-9c45d2a0.js').then(function (n) {
      return n.index;
    })),
...
//# sourceMappingURL=desk-3aa7b32c.js.map
