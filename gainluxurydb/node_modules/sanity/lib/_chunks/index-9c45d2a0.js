...
import { useElementRect, Box, Card, Container, Heading, Stack, Label, Code, Text, Button, Flex, _raf2, Spinner, useToast, rem, TextInput, Dialog, TabList, Tab, TabPanel, focusFirstDescendant, Tooltip, usePortal, PortalProvider, BoundaryElementProvider, Popover, useLayer, useClickOutside, useGlobalKeyDown, Grid, MenuButton, Menu, MenuItem, Hotkeys, LayerProvider, Inline, Badge, DialogProvider, useTheme, ErrorBoundary } from '@sanity/ui';
import { usePaneLayout, ChildLink, BackLink, ReferenceChildLink, ParameterizedLink, PaneRouterContext, PANE_DEFAULT_MIN_WIDTH, PANE_COLLAPSED_WIDTH, PaneLayoutContext, Root as Root$4, usePane, useDocumentPane, useDeskTool, Resizable, DOCUMENT_INSPECTOR_MAX_WIDTH, DOCUMENT_INSPECTOR_MIN_WIDTH, LOADING_PANE, SerializeError, Pane, PaneHeader, PaneContent, usePaneRouter, DocTitle, Delay, resolveMenuNodes, isMenuNodeButton, isNotMenuNodeButton, TimelineMenu, PaneHeaderActionButton, PaneContextMenuButton, DOCUMENT_PANEL_PORTAL_ELEMENT, HistoryRestoreAction, DocumentPaneProvider, PaneFooter, DOCUMENT_PANEL_INITIAL_MIN_WIDTH, DOCUMENT_PANEL_MIN_WIDTH, setActivePanes, DeskToolProvider } from './desk-3aa7b32c.js';
...
const paneMap = {
  component: lazy(() => import('./index-81f52524.js')),
  document: lazy(() => import('./index-0c341ec6.js')),
  documentList: lazy(() => import('./index-dcf26cea.js')),
  list: lazy(() => import('./index-7f46036d.js'))
};
...
//# sourceMappingURL=index-9c45d2a0.js.map
