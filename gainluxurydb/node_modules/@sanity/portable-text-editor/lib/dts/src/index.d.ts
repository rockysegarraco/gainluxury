...
export declare const PortableTextEditable: React_2.ForwardRefExoticComponent<
  Omit<
    Omit<React_2.TextareaHTMLAttributes<HTMLDivElement>, 'onCopy' | 'onPaste'> & {
      hotkeys?: HotkeyOptions | undefined
      onBeforeInput?: OnBeforeInputFn | undefined
    ...
    } & Omit<React_2.HTMLProps<HTMLDivElement>, 'onPaste' | 'as'>,
    'ref'
  > &
