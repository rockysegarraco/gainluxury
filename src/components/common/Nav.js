          ...
          <div className="flex h-16 justify-between">
            ...
            <div className="flex items-center">
              ...
              <button
                ...
                className="relative flex-shrink-0 rounded-full px-4 py-2 mr-3 text-base text-white bg-blue-600 hover:bg-blue-800 hover:text-white hidden lg:block font-inter"
              >
                List with us free
              </button>
              {isSignedIn ? (
