const navigation = {
  ...
  social: [
    {
      name: "Facebook",
      href: "https://www.facebook.com/profile.php?id=61554100619382",
      icon: (props) => (
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/gainluxury2024",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "Twitter",
      href: "https://twitter.com/GainLuxury81232",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      <div className="mx-auto max-w-[90%] px-6 pb-8 pt-16 sm:pt-24 lg:px-0 lg:pt-8">
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-400">
            &copy; 2024 Gain Luxury, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
