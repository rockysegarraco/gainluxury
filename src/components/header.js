...
const navigation = [
  { name: "Real Estate", href: "#", current: true },
  ...
  return (
    <>
      <Disclosure as="header" className="bg-white shadow">
        {({ open }) => (
          <>
            <div className="mx-auto max-w-full px-2 sm:px-4 lg:divide-y lg:divide-gray-200 lg:px-0">
              ...
              <nav
                className="hidden lg:flex lg:space-x-8 lg:py-2 px-8"
                aria-label="Global"
              >
                {navigation.map((item) => (
                  <a
