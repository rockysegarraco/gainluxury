      ...
      <div className="w-full lg:col-span-4 lg:pt-2">
        ...
        <div className="py-3">
          <button
            ...
            className="flex-none bg-gray-900 px-3.5 py-3.5 text-sm font-semibold text-white shadow-sm hover:bg-slate-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 w-full"
          >
            Subscribe
          </button>
        </div>
